...
export default function Home() {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center">
            ...
            <div className="border-8 border-border/20 bg-background/50 px-20 py-24 rounded-lg flex flex-col justify-center items-center">
                <div className="container flex flex-col gap-2 items-center justify-end pb-8">
